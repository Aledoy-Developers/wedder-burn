                     ...
                     <div class="col-lg-4 cont-details">
                         <address>
                            <p>For more info or inquiry about our services, please feel free to get in touch with us.</p>
                             ...
                             <p><a href="mailto: info@wedderburnelectrics.com" class="mail"><span class="fa fa-envelope-open-o"></span>
                              info@wedderburnelectrics.com</a></p>
      ...
      <div class="footer-29 py-5">
        <div class="container pb-lg-3">
          <div class="row footer-top-29">
            <div class="col-lg-4 col-md-6 footer-list-29 footer-1 mt-md-4">
              ...
              <ul>
                ...
                <li><a href="mailto: info@wedderburnelectrics.com" class="mail"><span class="fa fa-envelope-open-o"></span>
                    info@wedderburnelectrics.com</a></li>
              </ul>
              <div class="main-social-footer-29">
                <a href="#facebook" class="facebook"><span class="fa fa-facebook"></span></a>
                <a href="#twitter" class="twitter"><span class="fa fa-twitter"></span></a>
            ...
            <div class="col-lg-3 col-md-6 col-6 footer-list-29 footer-2 mt-4">
              <ul>
                ...
                <li><a href="services.html">Electrical Panels(Breaker box)</a></li>
                <li><a href="services.html">Knob & tube Whole Home Wiring</a></li>
                <li><a href="services.html">EV / Tesla Home Chargers</a></li>
                <li><a href="services.html">Ceiling Fan Installation</a></li>
                <li><a href="services.html">Outlet / Switches / Fixtures Updates</a></li>
          ...
          <div class="row bottom-copies">
            <p class="copy-footer-29 col-lg-8">© 2024 Wedder Burn Electrics. All rights reserved.</p>
